        ...
        <div className="m-controls-row">
          ...
          <div className="m-actions-group">
            ...
            <div className="m-action-subgroup">
              ...
              <button
                type="button"
                className={`m-btn-icon ${activeFlower.layer === 'front' ? 'm-btn-active-gold' : ''}`}
                onClick={() => toggleFlowerLayer(activeFlower.uid)}
                title={activeFlower.layer === 'front' ? 'Bunga di depan buket. Klik untuk selipkan.' : 'Bunga di dalam buket. Klik untuk ke depan buket.'}
              >
                <span className="m-btn-txt" style={{ fontWeight: 700 }}>
                  {activeFlower.layer === 'front' ? '✨ Di Depan' : '📥 Di Dalam'}
                </span>
              </button>
            </div>
