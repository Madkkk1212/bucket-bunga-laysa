...
export function preloadFlowers(
  ...
  const bucketUrls = [
    ...
    '/images/bucket/naruto-1.png',
    '/images/bucket/naruto-1_back.png',
    '/images/bucket/naruto-1_front.png',
    '/images/bucket/kuromi-1.png',
    '/images/bucket/kuromi-1_back.png',
    '/images/bucket/kuromi-1_front.png',
    '/images/bucket/stitch-1.png',
    '/images/bucket/stitch-1_back.png',
    '/images/bucket/stitch-1_front.png',
    '/images/bucket/doraemon-1.png',
    '/images/bucket/doraemon-1_back.png',
    '/images/bucket/doraemon-1_front.png',
    '/images/bucket/cinnamoroll-1.png',
    '/images/bucket/cinnamoroll-1_back.png',
    '/images/bucket/cinnamoroll-1_front.png',
    '/images/bucket/koran-1.png',
    '/images/bucket/koran-1_back.png',
    '/images/bucket/koran-1_front.png',
    '/images/bucket/koran-2.png',
    '/images/bucket/koran-2_back.png',
    '/images/bucket/koran-2_front.png',
    '/images/bucket/totoro-1.png',
    '/images/bucket/totoro-1_back.png',
    '/images/bucket/totoro-1_front.png',
    '/images/bucket/sailormoon-1.png',
    '/images/bucket/sailormoon-1_back.png',
    '/images/bucket/sailormoon-1_front.png',
    '/images/bucket/pikachu-1.png',
    '/images/bucket/pikachu-1_back.png',
    '/images/bucket/pikachu-1_front.png',
    '/images/bucket/hellokitty-1.png',
    '/images/bucket/hellokitty-1_back.png',
    '/images/bucket/hellokitty-1_front.png',
    '/images/bucket/heart-1.png',
    '/images/bucket/heart-1_back.png',
    '/images/bucket/heart-1_front.png',
    ...
    '/images/bucket/onepiece-1.png',
    '/images/bucket/onepiece-1_back.png',
    '/images/bucket/onepiece-1_front.png',
    '/images/bucket/onepiece-2.png',
    '/images/bucket/onepiece-2_back.png',
    '/images/bucket/onepiece-2_front.png',
    '/images/bucket/rustic-barrel.png',
    '/images/bucket/rustic-barrel_back.png',
    '/images/bucket/rustic-barrel_front.png',
    '/images/bucket/mini-1.png',
    '/images/bucket/mini-1_back.png',
    '/images/bucket/mini-1_front.png',
  ];
...
export function getBouquetDimensions(
  ...
  const bucketX = Math.round((canvasW - targetW) / 2) + offset.x;
  ...
  // Key landmarks calibrated to bucket geometry:
  // For Korean Origami wrap: Collar starts at Y = 1050 (in 1954px height)
  // For One Piece Mugiwara Tub: Deck rim is at Y = 645 (in 1077px height)
  // For Rustic Wooden Barrel: Front rim lip is at Y = 96 (in 320px height)
  const bucket = getBucketSize(bucketId);
  let collarRatio = 1050 / 1954;
  let topOffsetRatio = 80 / 1954;

  if (bucket.id === 'bucket-onepiece' || bucket.id === 'bucket-onepiece-2') {
    collarRatio = 645 / 1077;
    topOffsetRatio = 320 / 1077;
  } else if (bucket.id === 'bucket-rustic') {
    collarRatio = 96 / 320;
    topOffsetRatio = 30 / 320;
  } else if (bucket.id === 'bucket-naruto') {
    collarRatio = 0.38;
    topOffsetRatio = 0.05;
  } else if (bucket.id === 'bucket-kuromi') {
    collarRatio = 0.28;
    topOffsetRatio = 0.06;
  } else if (bucket.id === 'bucket-stitch') {
    collarRatio = 0.46;
    topOffsetRatio = 0.12;
  } else if (bucket.id === 'bucket-koran') {
    collarRatio = 0.50;
    topOffsetRatio = 0.08;
  } else if (bucket.id === 'bucket-doraemon') {
    collarRatio = 0.44;
    topOffsetRatio = 0.08;
  } else if (bucket.id === 'bucket-cinnamoroll') {
    collarRatio = 0.46;
    topOffsetRatio = 0.14;
  } else if (bucket.id === 'bucket-totoro') {
    collarRatio = 0.38;
    topOffsetRatio = 0.08;
  } else if (bucket.id === 'bucket-sailormoon') {
    collarRatio = 0.42;
    topOffsetRatio = 0.12;
  } else if (bucket.id === 'bucket-pikachu') {
    collarRatio = 0.35;
    topOffsetRatio = 0.10;
  } else if (bucket.id === 'bucket-hellokitty') {
    collarRatio = 0.34;
    topOffsetRatio = 0.10;
  } else if (bucket.id === 'bucket-koran-2') {
    collarRatio = 0.22;
    topOffsetRatio = 0.08;
  } else if (bucket.id === 'bucket-heart-box') {
    collarRatio = 0.48;
    topOffsetRatio = 0.20;
  }

  const ribbonY = Math.round(bucketY + targetH * collarRatio);
  const wrapperTopY = Math.round(bucketY + targetH * topOffsetRatio);
...
export function drawBouquetBack(
  ...
  void wrapperTypeId;
  const dims = getBouquetDimensions(ctx.canvas.width, ctx.canvas.height, bucketId, bouquetScale, offset);
  const bucket = getBucketSize(bucketId);
...
export function drawBouquetFront(
  ...
  if (frontImg && frontImg.complete && frontImg.naturalWidth) {
    ...
    const isLegacyKoreanFront = (
      frontImg.naturalWidth === 1200 && frontImg.naturalHeight === 798
    );

    if (isLegacyKoreanFront) {
      ...
      ctx.shadowBlur = 10;
      ctx.shadowOffsetY = 4;
      ctx.drawImage(frontImg, dims.bucketX, dims.bucketY, dims.bucketW, dims.bucketH);
    }
    ctx.restore();
    return;
  }
